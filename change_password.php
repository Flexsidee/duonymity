...
<head>
    ...
    <title>Change Password - Duonymity</title>
    ...
    <div class="container-contact100">
        ...
        <div class="wrap-contact100">
            ...
            <div class="contact100-form">
                ...
                <form class="contact100-form validate-form" method="POST" action="change_password_p">

                    <input type="hidden" value="<?php echo $user_id; ?>" name="user_id">
                    <div class="wrap-input100 validate-input" data-validate="Name is required">

                        <span class="label-input100">Enter Current Paaword</span>
                        <input class="input100" type="password" name="old_pword"
                            placeholder="Enter your current password" minlength="5" maxlength="16" autocomplete="off"
                            required>
                    ...
                    <div class="wrap-input100 validate-input">
                        ...
                        <input class="input100" type="password" name="new_pword" placeholder="Enter your new password"
                    ...
                    <div class="wrap-input100 validate-input">
                        ...
                        <input class="input100" type="password" name="re_pword" placeholder="Confirm your new password"
                            minlength="5" maxlength="16" autocomplete="off" required>
